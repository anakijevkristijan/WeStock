...
public class PriceService {
    ...
    public Double predictNextMonth(Long companyId) {
        ...
        List<AssetHistoryEntity> data = assetHistoryRepository.findByCompanyIdAndDateBetween(companyId, LocalDate.now().minusMonths(1), LocalDate.now());;
    ...
    public static List<Map<String, Object>> mapToRequestData(List<AssetHistoryEntity> historicalDataEntities) {
